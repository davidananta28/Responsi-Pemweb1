    ...
    <div class="form-admin-card">
        ...
        <form action="../../controllers/AdminController.php" method="POST" enctype="multipart/form-data" class="admin-main-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama_karakter" name="nama_karakter" value="<?php echo htmlspecialchars($anggota['nama_karakter']); ?>" required>
            </div>

            <div class="form-group">
                <label for="gelar">Gelar / Peran (Title)</label>
                <input type="text" id="gelar" name="gelar" value="<?php echo htmlspecialchars($anggota['gelar']); ?>" required>
            </div>

            <div class="form-group">
                <label for="id_faksi">Pengabdian / Faksi (House)</label>
                <select id="id_faksi" name="id_faksi" required>
                    <option value="" disabled>-- Pilih Faksi Tempat Karakter Bernaung --</option>
                    <option value="0" <?php echo ($anggota['id_faksi'] == '0' || empty($anggota['id_faksi'])) ? 'selected' : ''; ?>>Tidak Berafiliasi (Free Folk / Sellsword)</option>
            ...
            <div class="form-group">
                ...
                <textarea id="bio" name="bio" rows="4"><?php echo htmlspecialchars($anggota['bio']); ?></textarea>
            </div>
